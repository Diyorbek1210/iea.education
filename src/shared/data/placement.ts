...
export const placementQuestions: Question[] = [
  ...
  { q: "She asked me where I ___ from.", options: ["come", "came", "coming", "comes"], answer: 1 },
  {
    ...
    options: ["economic", "economical", "economy", "economically"],
    answer: 0,
  },
  ...
  },
  {
    ...
    options: ["hand", "reach", "order", "place"],
    answer: 0,
  },
];
