...
//#region node_modules/.nitro/vite/services/ssr/assets/server-ihsQcs9K.js
var server_ihsQcs9K_exports = /* @__PURE__ */ __exportAll$1({
	a: () => __exportAll,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CVlTwEx-.mjs");
...
var manifest = {
	"4cd9fd6db330fd332d42575b02c398a3e8b8020671124b61669ccc5d7b97b509": {
		functionName: "deleteAuthUser_createServerFn_handler",
		importer: () => import("./authAdmin-DOW2vqf1.mjs")
	},
	"b1777137039635edbe1f08a504100a14509249abc045553bd8c36e8b5c9f5119": {
		functionName: "scoreMockPerformance_createServerFn_handler",
		importer: () => import("./aiScoring-FTmaF6rB.mjs")
	},
	"daef94b3928363e7cc8c18cfd62b2ecf03ea36ddb53468b4a634d0117c53daa3": {
		functionName: "synthesizeSpeech_createServerFn_handler",
		importer: () => import("./tts-BGycEtZg.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CpIOtHbc.mjs").then((n) => n.t),
...
//#endregion
export { server_ihsQcs9K_exports as a, getServerFnById as i, __exportAll as n, createServerFn as r, TSS_SERVER_FUNCTION as t };
