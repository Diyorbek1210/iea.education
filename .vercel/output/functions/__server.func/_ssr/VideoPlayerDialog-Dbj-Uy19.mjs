...
//#region node_modules/.nitro/vite/services/ssr/assets/VideoPlayerDialog-Dbj-Uy19.js
...
function VideoPlayerDialog({ video, onOpenChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		open: video !== null,
		onOpenChange,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			className: "max-w-2xl",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: video?.title }) }), video && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
				src: video.url,
				controls: true,
				autoPlay: true,
